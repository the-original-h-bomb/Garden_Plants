...
account = os.environ.get("SF_STG_ACCOUNT")
user = os.environ.get("SF_STG_USERNAME")
password = os.environ.get("SF_STG_PASSWORD")
warehouse = os.environ['SF_STG_WAREHOUSE']
database = os.environ['SF_STG_DATABASE']
